...
//
// Spawns both the Subregistry and ResolverLive templates for every deployed
// proxy (network-agnostic, no implementation allowlist): like the v1 subgraph,
// which spawned a Resolver template for any resolver address a NewResolver
// event pointed at, handlers tolerate nodes they don't know about. Watching
// the factory captures every event after a proxy's deploy tx (ProxyDeployed is
// the last log of the deploy tx), making factory-based flows race-free.
//
